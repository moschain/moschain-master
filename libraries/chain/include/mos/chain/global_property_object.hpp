...
#include <mos/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(mos::chain::global_property_object, mos::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(mos::chain::dynamic_global_property_object,
                         mos::chain::dynamic_global_property_multi_index)

FC_REFLECT(mos::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(mos::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(mos::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(mos::chain::dynamic_global_property_object,
