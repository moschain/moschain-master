...
CHAINBASE_SET_INDEX_TYPE(mos::chain::permission_object, mos::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(mos::chain::permission_usage_object, mos::chain::permission_usage_index)

FC_REFLECT(mos::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(mos::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(mos::chain::permission_usage_object, (last_used))
