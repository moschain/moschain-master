...
FC_REFLECT_ENUM( mos::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(mos::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(mos::chain::transaction_receipt, (mos::chain::transaction_receipt_header), (trx) )
FC_REFLECT(mos::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(mos::chain::signed_block, (mos::chain::signed_block_header), (transactions)(block_extensions) )
