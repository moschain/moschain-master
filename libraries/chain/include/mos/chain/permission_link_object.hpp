...
CHAINBASE_SET_INDEX_TYPE(mos::chain::permission_link_object, mos::chain::permission_link_index)

FC_REFLECT(mos::chain::permission_link_object, (account)(code)(message_type)(required_permission))
