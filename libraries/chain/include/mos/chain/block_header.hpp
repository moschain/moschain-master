...
#include <mos/chain/protocol_feature_activation.hpp>
...
FC_REFLECT(mos::chain::block_header,
           (timestamp)(producer)(confirmed)(previous)
           (transaction_mroot)(action_mroot)
           (schedule_version)(new_producers)(header_extensions))

FC_REFLECT_DERIVED(mos::chain::signed_block_header, (mos::chain::block_header), (producer_signature))
