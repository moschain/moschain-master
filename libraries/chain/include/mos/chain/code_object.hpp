...
CHAINBASE_SET_INDEX_TYPE(mos::chain::code_object, mos::chain::code_index)

FC_REFLECT(mos::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
