...
using mosvmoc_message = fc::static_variant<initialize_message,
...
FC_REFLECT(mos::chain::mosvmoc::initialize_message, )
FC_REFLECT(mos::chain::mosvmoc::initalize_response_message, (error_message))
FC_REFLECT(mos::chain::mosvmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(mos::chain::mosvmoc::compile_wasm_message, (code))
FC_REFLECT(mos::chain::mosvmoc::evict_wasms_message, (codes))
FC_REFLECT(mos::chain::mosvmoc::code_compilation_result_message, (start)(apply_offset)(starting_memory_pages)(initdata_prologue_size))
FC_REFLECT(mos::chain::mosvmoc::compilation_result_unknownfailure, )
FC_REFLECT(mos::chain::mosvmoc::compilation_result_toofull, )
FC_REFLECT(mos::chain::mosvmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes))