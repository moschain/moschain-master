...
class memory {
      static constexpr uint64_t wasm_memory_size                  = mos::chain::wasm_constraints::maximum_linear_memory;
      ...
      static constexpr uint64_t mutable_global_size               = 8u  * mos::chain::wasm_constraints::maximum_mutable_globals/4u;
      static constexpr uint64_t table_size                        = 16u * mos::chain::wasm_constraints::maximum_table_elements;
      static constexpr size_t   wcb_allowance                     = 512u;
      static_assert(sizeof(control_block) <= wcb_allowance, "MOS VM OC memory doesn't set aside enough memory for control block");
   ...
   public:
      ...
      static_assert(-cb_offset == MOS_VM_OC_CONTROL_BLOCK_OFFSET, "MOS VM OC control block offset has slid out of place somehow");
      static_assert(stride == MOS_VM_OC_MEMORY_STRIDE, "MOS VM OC memory stride has slid out of place somehow");
...
#define OFFSET_OF_CONTROL_BLOCK_MEMBER(M) (-(int)mos::chain::mosvmoc::memory::cb_offset + (int)offsetof(mos::chain::mosvmoc::control_block, M))
#define OFFSET_OF_FIRST_INTRINSIC ((int)-mos::chain::mosvmoc::memory::first_intrinsic_offset)