...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "mosvmoc_internal.unreachable"_s,
   "mosvmoc_internal.grow_memory"_s,
   "mosvmoc_internal.div0_or_overflow"_s,
   "mosvmoc_internal.indirect_call_mismatch"_s,
   "mosvmoc_internal.indirect_call_oob"_s,
   "mosvmoc_internal.depth_assert"_s,
   "eosio_injection.call_depth_assert"_s,  //these two are never used by MOS VM OC but all intrinsics
