...
namespace std {
    template<> struct hash<mos::chain::mosvmoc::code_tuple> {
        size_t operator()(const mos::chain::mosvmoc::code_tuple& ct) const noexcept {
...
class code_cache_base {
   public:
      code_cache_base(const bfs::path data_dir, const mosvmoc::config& mosvmoc_config, const chainbase::database& db);
      ~code_cache_base();
...
class code_cache_async : public code_cache_base {
   public:
      code_cache_async(const bfs::path data_dir, const mosvmoc::config& mosvmoc_config, const chainbase::database& db);
      ~code_cache_async();
