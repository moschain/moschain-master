...
#include <mos/chain/action_receipt.hpp>
...
FC_REFLECT( mos::chain::account_delta,
            (account)(delta) )

FC_REFLECT( mos::chain::action_trace,
...
FC_REFLECT( mos::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
