...
#include <mos/chain/chain_id_type.hpp>
...
namespace mos { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in MOS code:
    *
    ...
    *  others are due to requirements to ensure determinism in the MOS chain library.
    *
...
FC_REFLECT_EMPTY( mos::chain::void_t )
