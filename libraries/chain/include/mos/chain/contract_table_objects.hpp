...
#include <mos/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(mos::chain::table_id_object, mos::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(mos::chain::key_value_object, mos::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(mos::chain::index64_object, mos::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(mos::chain::index128_object, mos::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(mos::chain::index256_object, mos::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(mos::chain::index_double_object, mos::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(mos::chain::index_long_double_object, mos::chain::index_long_double_index)

FC_REFLECT(mos::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(mos::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(mos::chain::index64_object)
REFLECT_SECONDARY(mos::chain::index128_object)
REFLECT_SECONDARY(mos::chain::index256_object)
REFLECT_SECONDARY(mos::chain::index_double_object)
REFLECT_SECONDARY(mos::chain::index_long_double_object)
