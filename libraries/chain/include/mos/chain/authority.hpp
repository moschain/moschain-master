...
FC_REFLECT(mos::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(mos::chain::key_weight, (key)(weight) )
FC_REFLECT(mos::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(mos::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(mos::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(mos::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(mos::chain::shared_public_key, (pubkey))