...
#include <mos/vm/error_codes.hpp>
#include <mos/vm/host_function.hpp>
#include <mos/vm/watchdog.hpp>
...
/**
 * Simple implementation of an interpreter using mos-vm.
 */
int main(int argc, char** argv) {
   ...
   using backend_t = mos::vm::backend<example_host_methods>;
   using rhf_t     = mos::vm::registered_host_functions<example_host_methods>;
   ...
   } catch (...) { std::cerr << "mos-vm interpreter error\n"; }
   return 0;
}
