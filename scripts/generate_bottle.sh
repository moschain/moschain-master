...
mkdir -p ${PROJECT}/${VERSION}/opt/mos/lib/cmake
...
echo "class Mos < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/mos/mos/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/mos/mos/releases/download/v${VERSION}\"
