#include <mos/producer_api_plugin/producer_api_plugin.hpp>
...
FC_REFLECT(mos::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     mos::detail::producer_api_plugin_response result{"ok"};
