...
CHAINBASE_SET_INDEX_TYPE( mos::public_key_history_object, mos::public_key_history_multi_index )

FC_REFLECT( mos::public_key_history_object, (public_key)(name)(permission) )
