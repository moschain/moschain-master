...
CHAINBASE_SET_INDEX_TYPE( mos::account_control_history_object, mos::account_control_history_multi_index )

FC_REFLECT( mos::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
